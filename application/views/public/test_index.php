<div class="center_content">
    <div class="home_section_left">
        ...
        <a href="" class="more"><img src="<?php echo base_url(); ?>images/more.gif" alt="" title="" border="0"></a>
        <div class="clear"></div>
    </div>
    <div class="home_section_left">
        <img src="<?php echo base_url(); ?>images/icon2.gif" alt="" title="" class="home_section_icon" border="0">
        <h2 class="home_title">Who we are</h2>
        <div class="home_subtitle">Tempor incididunt ut labore</div>
        <div class="home_section_thumb">
        <img src="<?php echo base_url(); ?>images/home_section_thumb2.jpg" alt="" title="" border="0">
        </div>
        <p><span>Lorem ipsum dolor sit ame</span><br>
        Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore. 
        <br> <br>
    ...
    <div class="home_section_left">
        <img src="<?php echo base_url(); ?>images/icon3.gif" alt="" title="" class="home_section_icon" border="0">
        <h2 class="home_title">Special services</h2>
        <div class="home_subtitle">Sed do eiusmod tempor</div>

        <div class="home_section_thumb">
        <img src="<?php echo base_url(); ?>images/home_section_thumb3.jpg" alt="" title="" border="0">
        </div>
        <p><span>Lorem ipsum dolor sit ame</span><br>
        Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore. 
        <br> <br>
    ...
    <div class="left_block_wide">
        ...
        <a href="#"><img src="<?php echo base_url(); ?>images/p1.jpg" alt="" title="" border="0" class="projects" /></a>
        <a href="#"><img src="<?php echo base_url(); ?>images/p2.jpg" alt="" title="" border="0" class="projects" /></a>
        <a href="#"><img src="<?php echo base_url(); ?>images/p3.jpg" alt="" title="" border="0" class="projects" /></a>
    </div>
