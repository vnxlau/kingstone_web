             ...
             <div id="featured_border" class="jcarousel-container">
                <div id="featured_wrapper" class="jcarousel-clip">
                   <ul id="featured_images" class="jcarousel-list">
                      <li><img src="<?php echo base_url(); ?>images/bannerImage1.jpg" width="965" height="280" alt="" /></li>
                      <li><img src="<?php echo base_url(); ?>images/bannerImage2.jpg" width="965" height="280" alt="" /></li>
                      <li><img src="<?php echo base_url(); ?>images/slider_photo3.jpg" width="965" height="280" alt="" /></li>
                      <li><img src="<?php echo base_url(); ?>images/slider_photo2.jpg" width="965" height="280" alt="" /></li>
                   </ul>
                </div>
